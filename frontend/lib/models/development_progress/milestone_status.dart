...
enum MilestoneStatus {
  ...
  ///
  /// This milestone is queued but development has not begun. It may be waiting for previous milestones to complete.
  pending,

  /// Milestone is currently being processed.
  ///
  /// Active work is being performed on this milestone. Progress updates may be available for detailed tracking.
  inProgress,

  /// Milestone has been successfully completed.
  ///
  /// All work for this milestone is finished and validated. Development can proceed to the next milestone.
  completed,

  /// Milestone has failed and requires intervention.
  ///
  /// An error occurred that prevents this milestone from completing. Manual review or system intervention may be required.
  failed,
}

/// Extension methods for MilestoneStatus enum.
///
/// Provides utility methods for working with milestone status values, including display formatting and state
/// validation.
extension MilestoneStatusExtension on MilestoneStatus {
  /// Returns a human-readable display name for the milestone status.
  ///
  /// These names are suitable for display in progress indicators and development timeline views.
  ...
  ///
  /// Active milestones are currently being processed and may have progress updates or require monitoring.
  bool get isActive {
  ...
  ///
  /// Terminal milestones have reached a final state (completed or failed) and will not change without external
  /// intervention.
  bool get isTerminal {
