...
void main() {
  group('Dashboard Integration', () {
    testWidgets('displays floating action button for creating new applications', (WidgetTester tester) async {
    ...
    testWidgets('displays create new app button in empty state', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestApp(
          child: const DashboardRoute(),
        ),
      ...
      expect(find.text('Create your first application to get started'), findsOneWidget);
    });

    testWidgets('can tap floating action button without errors', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestApp(
          child: const DashboardRoute(),
        ),
    ...
    testWidgets('displays application tiles when applications exist', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestApp(
          child: const DashboardRoute(),
        ),
    ...
    testWidgets('displays different application statuses correctly', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestApp(
          child: const DashboardRoute(),
        ),
    ...
    testWidgets('can tap application tiles without errors', (WidgetTester tester) async {
      await tester.pumpWidget(
        createTestApp(
          child: const DashboardRoute(),
        ),
      ...
      final Finder applicationTile = find.textContaining('Family Chore Tracker');
