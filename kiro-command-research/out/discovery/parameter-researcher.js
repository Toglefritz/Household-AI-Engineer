...
exports.ParameterResearcher = void 0;
/**
...
class ParameterResearcher {
     ...
     */
    async researchCommands(commandIds) {
        const signatures = [];
     ...
     */
    async researchCommand(commandId) {
        const sources = [];
        const parameters = [];
        let confidence = 'low';
        let returnType;
     ...
     */
    async findTypeScriptDefinitions(commandId) {
        try {
     ...
     */
    inferParametersFromStructure(commandId) {
        const parameters = [];
     ...
     */
    getResearchStatistics(signatures) {
        const stats = {
...
exports.ParameterResearcher = ParameterResearcher;
//# sourceMappingURL=parameter-researcher.js.map