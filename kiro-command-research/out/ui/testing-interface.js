...
exports.TestingInterface = void 0;
const vscode = __importStar(require("vscode"));
const path = __importStar(require("path"));
class TestingInterface {
    constructor(context, executor, validator, config) {
     ...
     */
    async openTestingInterface(command) {
        ...
        if (this.panel) {
            ...
            this.panel = vscode.window.createWebviewPanel('kiroCommandTesting', `Test: ${command.displayName}`, vscode.ViewColumn.One, {
                enableScripts: true,
    ...
    /**
      ...
      */
    async handleParameterValidation(parameters) {
        if (!this.currentCommand?.signature) {
            return;
        }
        const validationResult = await this.validator.validateParameters(this.currentCommand.signature.parameters, parameters, {
     ...
     */
    async handleTestExecution(request) {
  ...
  * Handles loading a recent test.
     ...
     */
    async handleLoadRecentTest(testId) {
...
exports.TestingInterface = TestingInterface;
