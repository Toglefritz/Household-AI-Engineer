...
exports.SideEffectDetector = void 0;
...
class SideEffectDetector {
    ...
    async stopMonitoring() {
        ...
        const sortedEffects = [...this.detectedEffects].sort((a, b) => a.timestamp.getTime() - b.timestamp.getTime());
     ...
     */
    async scanDirectory(dirPath, files, directories) {
        try {
     ...
     */
    compareFileSystemState(before, after) {
        const effects = [];
        // Find new files
     ...
     */
    compareEditorState(before, after) {
        const effects = [];
     ...
     */
    filesAreDifferent(before, after) {
...
//# sourceMappingURL=side-effect-detector.js.map