...
class SchemaGenerator {
     ...
     */
    generateCommandMetadataSchema(commands, testResults) {
        ...
        const schema = {
            ...
            definitions: {
                CommandMetadata: this.generateCommandSchema(commands, testResults),
                ParameterInfo: this.generateParameterSchema(),
                CommandSignature: this.generateSignatureSchema()
            }
        };
        return schema;
    }
     ...
     */
    generateTypeScriptDefinitions(commands, testResults) {
     ...
     */
    generateOpenApiSpec(commands, testResults) {
     ...
     */
    generateCompleteSchemaPackage(commands, testResults) {
     ...
     */
    generateCommandSchema(commands, testResults) {
        const examples = [];
     ...
     */
    generateCommandMetadataInterface() {
        return {
...
export interface CommandMetadata {
  ...
  readonly signature?: CommandSignature;
     ...
     * @returns TypeScript definition
     */
    generateParameterInfoInterface() {
        return {
            name: 'ParameterInfo',
            type: 'interface',
...
export interface ParameterInfo {
  ...
  readonly source: 'typescript' | 'documentation' | 'inference' | 'manual';
     ...
     * @returns TypeScript definition
     */
    generateCommandSignatureInterface() {
        return {
...
export interface CommandSignature {
  ...
  readonly researchedAt: Date;
     ...
     * @returns TypeScript definition
     */
    generateDiscoveryResultsInterface() {
        return {
...
export interface DiscoveryResults {
  ...
  readonly statistics: {
     ...
     * @returns TypeScript definition
     */
    generateCommandCategoryEnum(commands) {
...
export enum RiskLevel {
  ...
  Destructive = 'destructive'
     ...
     * @returns TypeScript definition
     */
    generateSubcategoryEnum(commands) {
...
${enumValues}
     ...
     * @returns TypeScript definition
     */
    generateCommandRegistryInterface(commands) {
        return {
...
export interface CommandRegistry {
  ...
  searchCommands(query: string): CommandMetadata[];
     ...
     * @returns TypeScript definition
     */
    generateWebSocketMessageInterface() {
        return {
...
export interface WebSocketMessage {
  ...
  readonly payload: any;
     ...
     * @returns TypeScript definition
     */
    generateExecutionRequestInterface() {
        return {
...
export interface ExecutionRequest {
  ...
  readonly requireConfirmation?: boolean;
     ...
     * @returns TypeScript definition
     */
    generateExecutionResponseInterface() {
        return {
...
export interface ExecutionResponse {
  ...
  readonly sideEffects: Array<{
     ...
     * @returns API paths
     */
    generateApiPaths(commands, testResults) {
        const paths = {};
     ...
     * @returns API schemas
     */
    generateApiSchemas(commands, testResults) {
        const schemas = {};
        schemas.CommandMetadata = this.generateCommandSchema(commands, testResults);
        schemas.ParameterInfo = this.generateParameterSchema();
        schemas.CommandSignature = this.generateSignatureSchema();
